...
CURE is a multi-robot exploration planner that first proposed using unknown regions to guide exploration. This is a minimalist version of CURE that you can quickly deploy and run.
...
- Apr, 2025: The code for **CURE** is released.
...
```bash
source devel/setup.bash && roslaunch lrae_planner exploration.launch
```

## Run CURE in other scenes

Modify lines 7-9 of three_p3dx.launch.
